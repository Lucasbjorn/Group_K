...
#define noiseFromRandom noiseFromRandom__MyNetStim 
#define position position__MyNetStim 
#define seed seed__MyNetStim 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 MyNetStim C:/Users/Spri/Desktop/BahlSynapsesPy-master/mynetstim.mod\n");
...
static int  seed ( _threadargsprotocomma_ double _la ) {
   set_seed ( _la ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "mynetstim.mod";
static const char* nmodl_file_text = 
